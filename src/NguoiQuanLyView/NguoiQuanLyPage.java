 ...
 * @author DELL
 */
public class NguoiQuanLyPage extends javax.swing.JFrame {

    /**
     * Creates new form NguoiQuanLyPage
     */
    public NguoiQuanLyPage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Quản lý phòng chiếu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NguoiQuanLyPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
